...
public class List_menu_items extends JFrame
{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			...
			public void run()
			{
				try
				{
					List_menu_items frame = new List_menu_items();
	...
	public List_menu_items()
	{
		ImageIcon piclabel = new ImageIcon("F:\\F-C-I\\FCI_MyWork\\Gusteau\\src\\picLabel.jpg");
		ImageIcon edit_icon = new ImageIcon("F:\\F-C-I\\FCI_MyWork\\Gusteau\\src\\edit.png");
		ImageIcon delete_icon = new ImageIcon("F:\\F-C-I\\FCI_MyWork\\Gusteau\\src\\icon_delete.png");
		...
		JLabel newItem_label = new JLabel("Add new item");
		newItem_label.setFont(new Font("Arial" , Font.BOLD , 12));
		newItem_label.setHorizontalAlignment(SwingConstants.CENTER);
		newItem_label.setBounds(15 , 60 , 106 , 25);
		right_panel.add(newItem_label);

		JButton add_category_button = new JButton("");
		add_category_button.setIcon(new ImageIcon("F:\\F-C-I\\FCI_MyWork\\Gusteau\\src\\plus.png"));
		...
		for (int i = 0 ; i < 20 ; i++)
		{
			...
			JLabel picLabel = new JLabel(piclabel);
			picLabel.setBounds(10 , 15 , 30 , 30);
			rowPanel.add(picLabel);

			JLabel name_label = new JLabel("Name");
			name_label.setBounds(60 , 15 , 80 , 30);
			rowPanel.add(name_label);

			JLabel category_label = new JLabel("Category");
			category_label.setBounds(160 , 15 , 80 , 30);
			rowPanel.add(category_label);

			JLabel description_label = new JLabel("Description");
			description_label.setBounds(280 , 15 , 80 , 30);
			rowPanel.add(description_label);

			JLabel price_label = new JLabel("Price");
			price_label.setBounds(400 , 15 , 80 , 30);
			rowPanel.add(price_label);
